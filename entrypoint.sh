...
/opt/mssql-tools/bin/sqlcmd -S "$HOST" -U sa -P "$PASSWORD" -d RustyHearts_Auth -i ./db/RustyHearts_Auth_RealTimeEventTable.sql
/opt/mssql-tools/bin/sqlcmd -S "$HOST" -U sa -P "$PASSWORD" -d RustyHearts_Log -i ./db/RustyHearts_Log.sql
/opt/mssql-tools/bin/sqlcmd -S "$HOST" -U sa -P "$PASSWORD" -d RustyHearts -i ./db/RustyHearts_Procedures_Fix.sql
